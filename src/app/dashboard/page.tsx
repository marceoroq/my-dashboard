export default function CounterPage() {
  return (
    <>
      <div className="mt-12 flex flex-col grow">
                    ...
                    <td className="py-3 px-5 border-b border-blue-gray-50">
                      <div className="w-10/12">
                        ...
                        <div className="flex flex-start bg-blue-gray-50 overflow-hidden w-full rounded-sm font-sans text-xs font-medium h-1">
                          <div className="flex justify-center items-center h-full w-[60%] bg-gradient-to-tr from-blue-600 to-blue-400 text-white"></div>
                        </div>
                      </div>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td className="py-3 px-5 border-b border-blue-gray-50">
                      <div className="w-10/12">
                        ...
                        <div className="flex flex-start bg-blue-gray-50 overflow-hidden w-full rounded-sm font-sans text-xs font-medium h-1">
                          <div className="flex justify-center items-center h-full w-[10%] bg-gradient-to-tr from-blue-600 to-blue-400 text-white"></div>
                        </div>
                      </div>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td className="py-3 px-5 border-b border-blue-gray-50">
                      <div className="w-10/12">
                        ...
                        <div className="flex flex-start bg-blue-gray-50 overflow-hidden w-full rounded-sm font-sans text-xs font-medium h-1">
                          <div className="flex justify-center items-center w-full h-full bg-gradient-to-tr from-green-600 to-green-400 text-white"></div>
                        </div>
                      </div>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td className="py-3 px-5 border-b border-blue-gray-50">
                      <div className="w-10/12">
                        ...
                        <div className="flex flex-start bg-blue-gray-50 overflow-hidden w-full rounded-sm font-sans text-xs font-medium h-1">
                          <div className="flex justify-center items-center h-full w-full bg-gradient-to-tr from-green-600 to-green-400 text-white"></div>
                        </div>
                      </div>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td className="py-3 px-5 border-b border-blue-gray-50">
                      <div className="w-10/12">
                        ...
                        <div className="flex flex-start bg-blue-gray-50 overflow-hidden w-full rounded-sm font-sans text-xs font-medium h-1">
                          <div className="flex justify-center items-center h-full w-[25%] bg-gradient-to-tr from-blue-600 to-blue-400 text-white"></div>
                        </div>
                      </div>
                    </td>
                  </tr>
